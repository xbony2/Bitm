...
public class furnacenyt extends BlockContainer{
	...
	public furnacenyt(boolean isactive) {
		super(Material.rock);
		...
		public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLivingBase, ItemStack itemstack){
			...
			if(itemstack.hasDisplayName()){
				((TileEntityNytFurnace)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
			}
		
		}
		
		public static void updatefurnacenytstate(boolean active, World worldObj, int xCoord, int yCoord, int zCoord){
			int i = worldObj.getBlockMetadata(xCoord, yCoord, zCoord);
			TileEntity tileentity = worldObj.getTileEntity(xCoord, yCoord, zCoord);
			keepInventory = true;
			
			if(active){
				worldObj.setBlock(xCoord, yCoord, zCoord, bonytechmod.furnacenytactive);
			}else{
				worldObj.setBlock(xCoord, yCoord, zCoord, bonytechmod.furnacenytidle);
			}
