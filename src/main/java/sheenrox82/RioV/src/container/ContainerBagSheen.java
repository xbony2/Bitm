...
public class ContainerBagSheen extends Container
{
	public final InventoryBagSheen inventory;

	private final ItemStack containerstack;

	public boolean needsUpdate;

	private static final int INV_START = InventoryBagSheen.INV_SIZE, INV_END = INV_START+26,
			HOTBAR_START = INV_END+1, HOTBAR_END = HOTBAR_START+8;
	
	public ContainerBagSheen(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryBagSheen inventoryItem)
	{
		...
		for (i = 0; i < InventoryBagSheen.INV_SIZE; ++i)
		{
	...
	public void writeToNBT()
	{
		...
		((InventoryBagSheen) inventory).writeToNBT(this.containerstack.getTagCompound());
	}
