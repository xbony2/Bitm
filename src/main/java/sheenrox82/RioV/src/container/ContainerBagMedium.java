...
public class ContainerBagMedium extends Container
{
	public final InventoryBagMedium inventory;

	private final ItemStack containerstack;

	public boolean needsUpdate;

	private static final int INV_START = InventoryBagMedium.INV_SIZE, INV_END = INV_START+26,
			HOTBAR_START = INV_END+1, HOTBAR_END = HOTBAR_START+8;
	
	public ContainerBagMedium(EntityPlayer par1Player, InventoryPlayer inventoryPlayer, InventoryBagMedium inventoryItem)
	{
		...
		for (i = 0; i < InventoryBagMedium.INV_SIZE; ++i)
		{
	...
	public void writeToNBT()
	{
		...
		((InventoryBagMedium) inventory).writeToNBT(this.containerstack.getTagCompound());
	}
