...
public class RioVPotions extends ItemBucket
{
	private Block isFull;

	public RioVPotions(Block par2)
	{
		super(par2);
		this.maxStackSize = 1;
		this.isFull = par2;
	        ...
	        else
	        {
	            ...
	            if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
	            {
	                ...
	                else
	                {
	                    ...
	                    {
	                        return new ItemStack(RioVItems.potionGlass);
	                    }
	                }
	            }
	...
	public boolean tryPlaceContainedLiquid(World par1World, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            {
                if (par1World.provider.isHellWorld && this.isFull == RioVBlocks.sanctuatiteMoving)
                {
