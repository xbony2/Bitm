	...
	public void replaceBlocksForBiome(int var1, int var2, Block[] var3, BiomeGenBase[] var4) {
		...
		for (int var8 = 0; var8 < 16; ++var8) {
			for (int var9 = 0; var9 < 16; ++var9) {
				...
				Block var15 = RioVBlocks.sanctuatiteGrass;
				...
				for (int var16 = 127; var16 >= 0; --var16) {
					...
					if (var16 <= 0 + this.rand.nextInt(5)) {
						...
						if (var18 == null) {
							...
							if (var13 == -1) {
								if (var12 <= 0) {
									var14 = RioVBlocks.sanctuatiteGrass;
									var15 = RioVBlocks.sanctuatiteDirt;
								}
								else if (var16 >= var5 - 4 && var16 <= var5 + 1) {
									var14 = RioVBlocks.sanctuatiteGrass;
									var15 = RioVBlocks.sanctuaryStone;
								}
								...
								if (var13 == 0 && var15 == RioVBlocks.sanctuatiteGrass) {
									var13 = -1;
									var15 = RioVBlocks.sanctuatiteDirt;
								}
							}
						...
						if (var13 > 0) {
							...
							if (var13 == 0 && var15 == RioVBlocks.sanctuaryStone) {
								var13 = -1;
								var15 = RioVBlocks.sanctuaryStone;
							}
						}
