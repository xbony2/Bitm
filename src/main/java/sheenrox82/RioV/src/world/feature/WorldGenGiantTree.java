...
public class WorldGenGiantTree extends WorldGenAbstractTree
{
    ...
    public WorldGenGiantTree(boolean p_i45458_1_, int p_i45458_2_, int p_i45458_3_, int p_i45458_4_, int p_i45458_5_)
    {
        super(p_i45458_1_);
