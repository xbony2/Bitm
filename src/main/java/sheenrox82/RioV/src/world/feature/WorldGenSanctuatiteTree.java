...
public class WorldGenSanctuatiteTree extends WorldGenAbstractTree
{
    private static final String __OBFID = "CL_00000435";

    public WorldGenSanctuatiteTree(boolean p_i2025_1_)
    {
        super(p_i2025_1_);
    }
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block1.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, (BlockRioVSapling)RioVBlocks.skywoodSapling);
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                    ...
                    for (i4 = 0; i4 <= j1; ++i4)
                    {
                        ...
                        for (int l2 = p_76484_3_ - l3; l2 <= p_76484_3_ + l3; ++l2)
                        {
                            ...
                            for (int j3 = p_76484_5_ - l3; j3 <= p_76484_5_ + l3; ++j3)
                            {
                                ...
                                {
                                    this.setBlockAndNotifyAdequately(p_76484_1_, l2, k2, j3, RioVBlocks.skycloud, 1);
                                }
                            }
                        }
                    ...
                    for (k2 = 0; k2 < l - i4; ++k2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_, RioVBlocks.skywoodLog, 1);
                        }
                    }
