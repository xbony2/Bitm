...
public class WorldGenVaerynMineable extends WorldGenerator
{
    ...
    public WorldGenVaerynMineable(Block p_i45459_1_, int p_i45459_2_)
    {
        this(p_i45459_1_, p_i45459_2_, RioVBlocks.glimmerRock);
    }

    public WorldGenVaerynMineable(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public WorldGenVaerynMineable(Block block, int meta, int number, Block target)
    {
