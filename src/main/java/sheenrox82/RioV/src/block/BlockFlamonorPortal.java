...
{	
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
	{
		if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
		{
			...
			else if (player.dimension != Config.flamonorID)
			{
				player.timeUntilPortal = 300;
				player.mcServer.getConfigurationManager().transferPlayerToDimension(player, Config.flamonorID, new TeleporterFlamonor(player.mcServer.worldServerForDimension(Config.flamonorID)));
			}
			else
			{
				player.timeUntilPortal = 300;
	...
	public static class Size
	{
		...
		public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
		{
			...
			this.field_150863_d = BlockFlamonorPortal.field_150001_a[p_i45415_5_][0];
			this.field_150866_c = BlockFlamonorPortal.field_150001_a[p_i45415_5_][1];
		...
		protected int func_150858_a()
		{
			...
			label56:
				...
				for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
				{
					...
					{
						k = this.field_150861_f.posX + j * Direction.offsetX[BlockFlamonorPortal.field_150001_a[this.field_150865_b][1]];
						l = this.field_150861_f.posZ + j * Direction.offsetZ[BlockFlamonorPortal.field_150001_a[this.field_150865_b][1]];
						...
						if (block == RioVBlocks.flamonorPortal)
						{
							++this.field_150864_e;
						}
						...
						if (j == 0)
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockFlamonorPortal.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[BlockFlamonorPortal.field_150001_a[this.field_150865_b][0]]);
						...
						{
							block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockFlamonorPortal.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[BlockFlamonorPortal.field_150001_a[this.field_150865_b][1]]);
			...
			{
				j = this.field_150861_f.posX + i * Direction.offsetX[BlockFlamonorPortal.field_150001_a[this.field_150865_b][1]];
				k = this.field_150861_f.posY + this.field_150862_g;
				l = this.field_150861_f.posZ + i * Direction.offsetZ[BlockFlamonorPortal.field_150001_a[this.field_150865_b][1]];
