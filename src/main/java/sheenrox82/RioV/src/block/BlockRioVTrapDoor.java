...
public class BlockRioVTrapDoor extends Block
{
    ...
    {
        if (disableValidation) return true;
        return Material.air.isOpaque() && p_150119_0_.renderAsNormalBlock() || p_150119_0_ == Blocks.glowstone || p_150119_0_ instanceof BlockSlab || p_150119_0_ instanceof BlockStairs;
    }
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		...
		if(this == RioVBlocks.bloodTrapdoor) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "bloodTrapDoor");
		if(this == RioVBlocks.skywoodTrapdoor) this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "skywoodTrapDoor");
	}
}
