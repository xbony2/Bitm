...
public class BlockRedFire extends BlockFire
{
    ...
    {
        if (p_149726_1_.provider.dimensionId > 0 || !((BlockFlamonorPortal) RioVBlocks.flamonorPortal).func_150000_e(p_149726_1_, p_149726_2_, p_149726_3_, p_149726_4_))
        {
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        if (!World.doesBlockHaveSolidTopSurface(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_) && !((BlockRedFire) RioVBlocks.redFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ - 1, p_149734_4_, UP))
        {
            if (((BlockRedFire) RioVBlocks.redFire).canCatchFire(p_149734_1_, p_149734_2_ - 1, p_149734_3_, p_149734_4_, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockRedFire) RioVBlocks.redFire).canCatchFire(p_149734_1_, p_149734_2_ + 1, p_149734_3_, p_149734_4_, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockRedFire) RioVBlocks.redFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (((BlockRedFire) RioVBlocks.redFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_, p_149734_4_ + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
            ...
            if (((BlockRedFire) RioVBlocks.redFire).canCatchFire(p_149734_1_, p_149734_2_, p_149734_3_ + 1, p_149734_4_, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)p_149734_2_ + p_149734_5_.nextFloat();
    ...
    {
    	this.field_149850_M = new IIcon[] {p_149651_1_.registerIcon(Util.MOD_ID + ":" + "redFire_layer_0"), p_149651_1_.registerIcon(Util.MOD_ID + ":" + "redFire_layer_1")};
    }
